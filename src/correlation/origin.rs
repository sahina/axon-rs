...
impl CorrelationProvider<EventMessage> for MessageOriginProvider {
...
mod originator_correlation_test {
    use crate::correlation::origin::MessageOriginProvider;
    use crate::correlation::CorrelationProvider;
    use crate::ddd::constant::TRACE_ID_KEY;
    use crate::message::generic::EventMessage;
    ...
    fn test_origin_correlation() {
        ...
        let correlation = MessageOriginProvider::new("cor-1", "trace-id");
